...
class ExtractPatch(PatchProcessor):
    ...
    def get_anno_mask(self):
        ...
        anno_dict = self.get_anno_dict1() if self.slide_path[-4:] == 'mrxs' else self.get_anno_dict3()
...
def extract(main, slide_path, save_path):
    anno_path = slide_path.replace('.svs', '.xml')

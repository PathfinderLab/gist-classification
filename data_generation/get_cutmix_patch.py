...
if __name__ == '__main__':
    ...
    parser.add_argument('-cp', '--cutmix_path', required=True, help='Path to generated cutmix patches')
    parser.add_argument('-nns', '--num_nor_sch', required=False, default=20000, help='Number of normal-schwannoma')
    parser.add_argument('-nnl', '--num_nor_lei', required=False, default=16000, help='Number of normal-leiomyoma')
    parser.add_argument('-nls', '--num_lei_sch', required=False, default=16000, help='Number of leiomyoma-schwannoma')
    ...
    CUTMIX_PATH = args['cutmix_path']
    NUM_NOR_SCH = args['num_nor_sch']
    NUM_NOR_LEI = args['num_nor_lei']
    NUM_LEI_SCH = args['num_lei_sch']
